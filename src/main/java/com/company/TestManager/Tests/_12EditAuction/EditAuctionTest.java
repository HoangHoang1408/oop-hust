...
public class EditAuctionTest extends Test {
    ...
    protected void beforeAll() throws IOException {
        ...
        CreateAuctionResponse resAuction = Connection.sendPostRequest(this.baseURLString +"/"+ Constant.CREATE_AUCTION,tempParams, CreateAuctionResponse.class, access_token);
