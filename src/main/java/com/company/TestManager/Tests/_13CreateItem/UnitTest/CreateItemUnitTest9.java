...
public class CreateItemUnitTest9 extends UnitTest {
    ...
    public void test() throws IOException {
        ...
        this.params = CreateAuctionTest.generateDefaultParams();
        CreateAuctionResponse resAuction1 = Connection.sendPostRequest(this.baseURLString + "/" + Constant.CREATE_AUCTION, this.params, CreateAuctionResponse.class, this.getAccessToken());
        this.params = CreateItemTest.generateDefaultParams();
        CreateItemResponse res1 = Connection.sendPostRequest(this.fullURLString + "/" + resAuction1.data.auction_id, this.params, CreateItemResponse.class, this.getAccessToken());
