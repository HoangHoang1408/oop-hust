...
public class CreateItemUnitTest5 extends UnitTest  {
    public CreateItemUnitTest5(Test test){super(test, "If more than 255 characters are entered in the name field, the response code will be 1001 and the data should be null");}
